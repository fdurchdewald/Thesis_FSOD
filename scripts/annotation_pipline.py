...
image_dir = '/Users/felixdurchdewald/devBA/Data/customDataset/images/train'
image_names = [f for f in os.listdir(image_dir) if f.endswith('.jpg')]

# Configuration of the SAM model
sam_dir = '/Users/felixdurchdewald/devBA/Data/customDataset/skripts'
sam_checkpoint = os.path.join(sam_dir, 'sam_vit_l_0b3195.pth')
model_type = 'vit_l'
device = 'mps'
